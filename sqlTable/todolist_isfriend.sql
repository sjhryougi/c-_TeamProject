...
CREATE TABLE `isfriend` (
  `sender` int NOT NULL COMMENT '친구 신청을 보낸 사람의 uid',
  `receiver` int NOT NULL COMMENT '친구 신청을 받은 사람의 uid',
  PRIMARY KEY (`sender`,`receiver`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='친구 신청 유무를 확인하기 위한 db';
...
-- Dump completed on 2023-05-28 12:07:00
